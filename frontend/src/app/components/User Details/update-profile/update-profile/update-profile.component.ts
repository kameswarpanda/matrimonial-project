...
@Component({
  ...
  standalone: true,
  imports: [NavbarComponent, RouterOutlet, RouterLink,RouterLinkActive, UpdatePersonalInfoComponent, UpdateEducationalInfoComponent, UpdateUserInfoComponent, UpdateFamilyInfoComponent],
